...
pcl_plot = SQ2PCL(grasp_params, SQ_type_grasp);
pcwrite(pointCloud(pcl_plot), 'objOut', 'PLYFormat', 'binary');

%% ACTION, GRASP MATCH FROM AVAILABLE PARTS

part_location = 'C:\GRA\Macgyver_code\Level_1_MG_v3\Segment_parts';
