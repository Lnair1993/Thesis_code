...
function [action_pcl_tf, grasp_pcl_tf, min_grasp_x, max_action_x, att_point_action, att_point_grasp] = parts_orient(action_match, grasp_match, angle_relative, pos_relative, part_location)
    ...
    tform_grasp = affine3d(tform_grasp');
    action_object = pctransform(action_object, tform_grasp);
