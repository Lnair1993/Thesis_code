...
def output_reader(output_file, reference_action=None, learning_file=None, constr_file = None):
...
main_folder_loc = '/home/lnair3/Output_ranking_final_DS_dual_constr' #'/home/lnair3/Output_ranking_final_DS' 
tool_folders = ['Hit', 'Rake', 'Scoop', 'Screw', 'Squeegee'] #['Flip', 'Hit', 'Rake', 'Scoop', 'Screw', 'Squeegee'] # FLIP
num_sub_cases = 10
