...
def main():
    ...
    test.lower_raise_arm(0.1 + 2*z_dist, plan_cartesian=True, execute_flag=True)
    test.grip_object(0.0)
    ...
    test.move_over_objects(test_pose, plan_cartesian=False, execute_flag=True)
    test.lower_raise_arm(0.109 + 3*z_dist, plan_cartesian=True, execute_flag=True)
