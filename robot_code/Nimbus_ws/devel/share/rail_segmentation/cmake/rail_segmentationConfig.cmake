...
if(NOT "/home/lnair3/Nimbus_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rail_segmentation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lnair3/Nimbus_ws/src/rail_segmentation/${idir}'.  Ask the maintainer 'Russell Toris <russell.toris@gmail.com>, David Kent <davidkent@wpi.edu>' to fix it.")
    endif()
