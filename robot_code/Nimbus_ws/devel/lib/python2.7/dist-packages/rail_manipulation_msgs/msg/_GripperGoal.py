...
class GripperGoal(genpy.Message):
  _md5sum = "782451e32b8c1c12dc59d6162ac85c6b"
...
"""
  __slots__ = ['close','speed','force','position']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3d.pack(_x.close, _x.speed, _x.force, _x.position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.close, _x.speed, _x.force, _x.position,) = _struct_B3d.unpack(str[start:end])
