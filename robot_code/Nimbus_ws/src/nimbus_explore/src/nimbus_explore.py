...
main_folder_loc = '/home/lnair3/Output_ranking_final_DS_random' #'/home/lnair3/Output_ranking_final_DS' 
tool_folders = ['Flip'] #['Flip', 'Hit', 'Rake', 'Scoop', 'Screw', 'Squeegee'] # FLIP
num_sub_cases = 1
