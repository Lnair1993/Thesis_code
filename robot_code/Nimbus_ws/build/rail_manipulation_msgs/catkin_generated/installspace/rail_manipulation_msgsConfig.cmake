...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rail_manipulation_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lnair3/Nimbus_ws/install/${idir}'.  Ask the maintainer 'David Kent <dekent@gatech.edu>, Russell Toris <russell.toris@gmail.com>' to fix it.")
    endif()
