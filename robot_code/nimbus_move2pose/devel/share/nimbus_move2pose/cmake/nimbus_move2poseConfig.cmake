...
if("TRUE" STREQUAL "TRUE")
  ...
  set(nimbus_move2pose_DEVEL_PREFIX /home/lnair3/Nimbus_ws/src/nimbus_move2pose/devel)
  ...
  set(nimbus_move2pose_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nimbus_move2pose' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lnair3/Nimbus_ws/src/nimbus_move2pose/${idir}'.  Ask the maintainer 'Lakshmi Nair <lnair3@gatech.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lnair3/Nimbus_ws/src/nimbus_move2pose/devel/lib;/home/lnair3/Nimbus_ws/devel/lib;/opt/ros/indigo/lib)
